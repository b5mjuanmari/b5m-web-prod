...
replace(replace(decode(a.nomedif_e,null,a.calle_e||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_e,a.nomedif_e||' - '||a.calle_e||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_e),' - , ',','),'  ',' ') name_eu,
replace(replace(decode(a.nomedif_e,null,decode(regexp_replace(a.calle_c,'[^,]+'),',',upper(substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),1,1))||''||substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),2,length(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' ')))||' '||regexp_substr(a.calle_c,'[^,]+',1,1),a.calle_c)||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_c,a.nomedif_e||' - '||decode(regexp_replace(a.calle_c,'[^,]+'),',',upper(substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),1,1))||''||substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),2,length(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' ')))||' '||regexp_substr(a.calle_c,'[^,]+',1,1),a.calle_c)||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_c),' - , ',','),'  ',' ') name_es,
a.codmuni codmuni,
a.muni_e muni_eu,
a.muni_c muni_es,
...
replace(replace(replace(decode(a.nomedif_e,null,a.calle_e||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_e,a.nomedif_e||' - '||a.calle_e||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_e),' - , ',','),',  ',''),'  ',' ') name_eu,
replace(replace(replace(decode(a.nomedif_c,null,decode(regexp_replace(a.calle_c,'[^,]+'),',',upper(substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),1,1))||''||substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),2,length(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' ')))||' '||regexp_substr(a.calle_c,'[^,]+',1,1),a.calle_c)||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_c,a.nomedif_c||' - '||decode(regexp_replace(a.calle_c,'[^,]+'),',',upper(substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),1,1))||''||substr(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' '),2,length(ltrim(regexp_substr(a.calle_c,'[^,]+',1,2),' ')))||' '||regexp_substr(a.calle_c,'[^,]+',1,1),a.calle_c)||', '||a.noportal||decode(a.bis,' ','',a.bis)||decode(a.codpostal,' ','',' '||a.codpostal)||' '||a.muni_c),' - , ',','),',  ',''),'  ',' ') name_es,
a.codmuni codmuni,
a.muni_e muni_eu,
a.muni_c muni_es,
a.codcalle codstreet,
...
b.grid_dw,
a.year,
decode(instr(listagg(d.format_dir,';') within group (order by d.format_dir),'year'),0,a.path_dw,replace(replace(listagg(a.path_dw||'/'||d.format_dir,';') within group (order by d.format_dir),'year2',substr(a.year,3)),'year',a.year||a.subcode)) path_dw,
listagg(d.template_dir,';') within group (order by d.id_format_dir) template_dw,
replace(replace(listagg(d.format_dir,';') within group (order by d.format_dir),'year2',substr(a.year,3)),'year',a.year) url_dw,
