...
a.format_dw,
replace(replace(replace('https://b5m.gipuzkoa.eus/'||e.format_dir||'/'||a.name_grid||c.template_dw,'*',''),a.name_grid,e.format_file1||a.name_grid||e.format_file2),'year',c.year) url_dw,
g.file_type_dw,
a.size_by file_size,
